...
INSERT INTO "users" VALUES ('User','C.so Galileo Ferraris, 137, 10128 Torino TO;lat:45.0519511;lng:7.6618593',0);
...
INSERT INTO "reviews" VALUES (17, 'Davide', 5, DATE('2024-02-26'), "Great options but a bit lacking in flavor", "I was excited to try the gluten-free menu, given my gluten sensitivity. The variety was impressive, and it's rare to find a place that cares so much about dietary restrictions. However, while the effort is commendable, the dishes, although beautifully presented, were somewhat lacking in depth and flavor. It felt like the removal of gluten also took away some of the joy from the dishes. That said, the ambiance was lovely, and the staff were incredibly accommodating and knowledgeable about gluten-related issues, which made the experience much more comfortable for me.", 3, 4, 5);
